    ...
    <div className="page-pad">
      <div className="page-heading">
        ...
        >
          {generating ? (
            <>
              <Loader2 className="spin" size={17} /> Generating...
            </>
          ) : (
            <>
              <FileDown size={17} /> Generate PDF
            </>
          )}
        </button>
      </div>
      ...
      <div className="report-layout">
        <section className="panel report-controls">
          ...
          <div className="demo-note">
            <ShieldCheck size={18} />
            <span>
              The transaction graph below is the same live wallet graph used
              by Wallet Tracer.
            </span>
          </div>
        </section>
        ...
        <section className="panel report-preview" ref={reportRef}>
          <div className="report-paper">
            <div className="report-brand">
              CHANDIGARH POLICE <span>CYBER CRIME CELL</span>
            </div>
            <h2>
              CRYPTO TRANSACTION
              <br />
            ...
            <div className="report-meta">
              ...
              <div>
                ...
                <b>{caseData.investigator}</b>
              </div>
              <div>
                <span>EST. ILLICIT FUNDS</span>
                <b>
                  ₹{caseData.estimatedIllicitFundsINR.toLocaleString("en-IN")}
                </b>
              </div>
            </div>
            ...
            <div className="report-graph">
              {walletAddress ? (
                ...
                <div className="report-empty-graph">
                  <ShieldCheck size={20} />
                  <strong>No wallet selected</strong>
                  <span>
                    Open Wallet Tracer, analyse a wallet, then return here to
                    include that same graph in the dossier.
                  </span>
                </div>
              )}
            </div>
            ...
            <div className="report-footer">
              LIVE WALLET GRAPH · {walletAddress || "NO WALLET SELECTED"} ·
      ...
      {done && (
        <div className="toast">
          <CheckCircle2 size={17} /> Evidence dossier generated successfully.
        </div>
      )}
    </div>
  );
