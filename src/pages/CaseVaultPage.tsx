...
export default function CaseVaultPage({
  ...
  const relatedWalletIds = useMemo(() => {
    ...
    // Expand two transaction hops so the vault shows the same
    // investigation-network language used by the Wallet Tracer.
          ...
          <section className="vault-detail">
            <div className="panel case-hero-panel">
              <div className="case-hero-top">
                ...
                <div className={`priority-badge large ${priorityClass(selectedCase.priority)}`}>
            ...
            <div className="case-metrics">
              <div className="panel vault-metric">
                ...
                <strong>{relatedWalletIds.size}</strong>
              ...
              <section className="panel case-info-panel">
                ...
                <div className="detail-grid">
                  ...
                  <div>
                    ...
                    <strong>{selectedCase.firNumber}</strong>
                  </div>
                  <div>
                    <span>INVESTIGATOR</span>
                    <strong>{selectedCase.investigator}</strong>
                  </div>
                  <div>
                    <span>STATUS</span>
                  ...
                  <div>
                    ...
                    <strong>
                      ₹{selectedCase.estimatedIllicitFundsINR.toLocaleString("en-IN")}
                    </strong>
                  </div>
                </div>
                ...
                <div className="activity-list">
                  {investigatorActivity.length === 0 ? (
                    <div className="vault-empty compact">
                      <span>No activity recorded for this case.</span>
                    </div>
                  ) : (
